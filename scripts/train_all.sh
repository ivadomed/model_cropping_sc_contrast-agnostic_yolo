...
echo ""
echo "  Next — export a release bundle:"
echo "    python scripts/export_model.py --run-dir ${DET_RUN} --cls-run-dir ${CLS_RUN} --version <MODEL_VERSION>"
echo "  Then edit scripts/release.sh (DET_RUN/CLS_RUN/versions) and run:"
echo "    bash scripts/release.sh --release-only"
echo "══════════════════════════════════════════════════════════════"
