...
METRICS = {
    ...
    "iou_3d_mm_graphreg":  True,
    "gap_mm_R_graphreg":   False,
    "gap_mm_L_graphreg":   False,
    "gap_mm_P_graphreg":   False,
    "gap_mm_A_graphreg":   False,
    "gap_mm_I_graphreg":   False,
    "gap_mm_S_graphreg":   False,
    "gap_mm_R_graphreg_neg": True,
    "gap_mm_L_graphreg_neg": True,
    "gap_mm_P_graphreg_neg": True,
    "gap_mm_A_graphreg_neg": True,
    "gap_mm_I_graphreg_neg": True,
    "gap_mm_S_graphreg_neg": True,
    "iou_3d_mm_graphtrim": True,
    "gap_mm_R_graphtrim":  False,
    "gap_mm_L_graphtrim":  False,
    "gap_mm_P_graphtrim":  False,
    "gap_mm_A_graphtrim":  False,
    "gap_mm_I_graphtrim":  False,
    "gap_mm_S_graphtrim":  False,
    "gap_mm_R_graphtrim_neg": True,
    "gap_mm_L_graphtrim_neg": True,
    "gap_mm_P_graphtrim_neg": True,
    "gap_mm_A_graphtrim_neg": True,
    "gap_mm_I_graphtrim_neg": True,
    "gap_mm_S_graphtrim_neg": True,
}
...
METRIC_IOU_THRESH = {
    ...
    "iou_3d_mm_graphreg":  None,
    "gap_mm_R_graphreg":   None,
    "gap_mm_L_graphreg":   None,
    "gap_mm_P_graphreg":   None,
    "gap_mm_A_graphreg":   None,
    "gap_mm_I_graphreg":   None,
    "gap_mm_S_graphreg":   None,
    "gap_mm_R_graphreg_neg": None,
    "gap_mm_L_graphreg_neg": None,
    "gap_mm_P_graphreg_neg": None,
    "gap_mm_A_graphreg_neg": None,
    "gap_mm_I_graphreg_neg": None,
    "gap_mm_S_graphreg_neg": None,
    "iou_3d_mm_graphtrim": None,
    "gap_mm_R_graphtrim":  None,
    "gap_mm_L_graphtrim":  None,
    "gap_mm_P_graphtrim":  None,
    "gap_mm_A_graphtrim":  None,
    "gap_mm_I_graphtrim":  None,
    "gap_mm_S_graphtrim":  None,
    "gap_mm_R_graphtrim_neg": None,
    "gap_mm_L_graphtrim_neg": None,
    "gap_mm_P_graphtrim_neg": None,
    "gap_mm_A_graphtrim_neg": None,
    "gap_mm_I_graphtrim_neg": None,
    "gap_mm_S_graphtrim_neg": None,
}
...
METRIC_COLUMN.update({
    ...
    "gap_mm_R_graphreg_neg": "gap_mm_R_graphreg",
    "gap_mm_L_graphreg_neg": "gap_mm_L_graphreg",
    "gap_mm_P_graphreg_neg": "gap_mm_P_graphreg",
    "gap_mm_A_graphreg_neg": "gap_mm_A_graphreg",
    "gap_mm_I_graphreg_neg": "gap_mm_I_graphreg",
    "gap_mm_S_graphreg_neg": "gap_mm_S_graphreg",
    "gap_mm_R_graphtrim_neg": "gap_mm_R_graphtrim",
    "gap_mm_L_graphtrim_neg": "gap_mm_L_graphtrim",
    "gap_mm_P_graphtrim_neg": "gap_mm_P_graphtrim",
    "gap_mm_A_graphtrim_neg": "gap_mm_A_graphtrim",
    "gap_mm_I_graphtrim_neg": "gap_mm_I_graphtrim",
    "gap_mm_S_graphtrim_neg": "gap_mm_S_graphtrim",
})
